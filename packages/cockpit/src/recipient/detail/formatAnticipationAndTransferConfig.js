function formatAnTConfig (data) {
  ...
  if (data.bank_account.document_type === 'cpf' && data.register_information !== null) {
    companyData = {
      ...companyData,
      name: data.register_information.name,
    }
  }
  if (data.bank_account.document_type === 'cnpj' && data.register_information !== null) {
    companyData = {
      ...companyData,
