...
import getTimestampFromBirthDate from '../../formatters/birthdate'

describe.only('Company register build parameters', () => {
  ...
  describe('Partner data', () => {
    ...
    it('should have partner_birthday', () => {
      const expectedBirthdate = getTimestampFromBirthDate('birthDate')(registerData)
